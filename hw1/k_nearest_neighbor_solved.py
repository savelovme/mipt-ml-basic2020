...
class KNearestNeighbor:
    ...
    def compute_distances_two_loops(self, X):
        ...
        for i in range(num_test):
            for j in range(num_train):
                ...
                dists[i, j] = np.square((self.X_train[j] - X[i])).sum() ** 0.5
    ...
    def compute_distances_one_loop(self, X):
        ...
        for i in range(num_test):
            ...
            #######################################################################
            # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
            dists[i, :] = np.square((self.X_train - X[i])).sum(axis=1) ** 0.5
            # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
    ...
    def compute_distances_no_loops(self, X):
        ...
        #########################################################################
        # *****START OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        X_train_square = np.sum(self.X_train**2, axis=1).reshape((1, self.X_train.shape[0]))
        X_square = np.sum(X**2, axis=1).reshape((num_test, 1))
        dists = np.sqrt(X_square + X_train_square - 2 * np.dot(X, self.X_train.T))
        # *****END OF YOUR CODE (DO NOT DELETE/MODIFY THIS LINE)*****
        return dists
